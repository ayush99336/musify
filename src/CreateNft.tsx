      ...
      <form onSubmit={handleSubmit} className="create-nft-form">
        <div className="form-section">
            ...
            <div className="form-group">
                ...
                <input type="file" accept="image/*" onChange={(e) => setCoverImage(e.target.files ? e.target.files[0] : null)} required />
            </div>
            <div className="form-group">
                <label>Audio File</label>
                <input type="file" accept="audio/*" onChange={(e) => setAudioFile(e.target.files ? e.target.files[0] : null)} required />
            </div>
        </div>
